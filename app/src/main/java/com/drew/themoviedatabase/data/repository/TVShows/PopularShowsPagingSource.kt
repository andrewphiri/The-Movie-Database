...
class PopularShowsPagingSource @Inject constructor(
    private val tvShowsRepository: TVShowsRepository) : PagingSource<Int, com.drew.themoviedatabase.data.model.TVShowDetails>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, com.drew.themoviedatabase.data.model.TVShowDetails> {
        return try {
            ...
            val shows = tvShowsRepository.fetchPopularTVShowsDetails(pageNumber)
