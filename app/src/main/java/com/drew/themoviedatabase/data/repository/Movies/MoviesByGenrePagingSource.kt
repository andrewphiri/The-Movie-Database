...
data class MoviesByGenrePagingSource(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MovieDetailsReleaseData> {
        return try {
            ...
            val moviesByGenre = movieRepository.fetchMoviesByGenre(pageNumber, genreId = genreId)
            val data = moviesByGenre?.filterNotNull() ?: emptyList()
