...
data class MoviesWatchlistPagingSource @Inject constructor(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MovieDetailsReleaseData> {
        return try {
            ...
            val movies = repository.fetchWatchlistMovieDetails(pageNumber,accountId = accountId, sessionId = sessionId )
            val data = movies?.filterNotNull() ?: emptyList()
